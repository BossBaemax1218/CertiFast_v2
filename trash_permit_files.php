...
$sql = "SELECT * FROM tbl_trash_permit";
...
<?php include 'templates/loading_screen.php' ?>
	<div class="wrapper">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="residenttable" class="trash-table">
                                                ...
                                                <tbody>
                                                <?php if (!empty($permittrash)): ?>
                                                    <?php $no = 1; foreach ($permittrash as $row): ?>
                                                    <tr>
                                                        <td><?= $row['date_deleted'] ?></td>
                                                        <td>
                                                            <?= ucwords($row['business_name']) ?>
                                                        </td>
                                                        <td><?= ucwords($row['owner1']) ?></td>
        ...
        <?php foreach ($permittrash as $row) { ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer mt-2 d-flex justify-content-center">
                        <form method="post" action="model/remove_permit.php">
        ...
        <div class="modal fade" id="restoreModal<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer mt-2 d-flex justify-content-center">
                        <form method="post" action="model/restore_archive_permit.php">
                            <input type="hidden" name="id" value="<?= $row['id'] ?>">
                            <button type="button" class="btn btn-danger text-center mr-2" data-dismiss="modal">No</button>
                            <button type="submit" class="btn btn-primary text-center">Yes</button>
                        </form>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  clearFiltersBtn.addEventListener("click", clearFilters);
    ...
    <script>
        ...
        console.log("Exporting support table as PDF...");

        const currentDate = new Date().toISOString().slice(0, 10);

        const title = "Support Trash Files - " + currentDate;
        const filename = "Support_" + currentDate + ".pdf";
