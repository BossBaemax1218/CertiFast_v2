        ...
        <section class="container forms">
            <div class="form" id="myForm">
                <div class="form-content">      
                    <form method="POST" action="model/email_confirmation.php">
                        <div class="header-title text-center mt-3 mb-3">
                            <h4 class="text-center">Account Confirmation</h4>
                            <span class="text-center">Please re-enter your email address for new verification code.</span>
                        </div>
