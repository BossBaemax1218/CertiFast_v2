                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_pment.php">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" value="<?= $row['requester'] ?>" class="form-control payment-control btn btn-light btn-info">
                                </div>
                                <div class="form-group">
                                    <label for="payment-details">Payment Details</label>
                                    <textarea id="details" name="details" placeholder="Enter Payment Details" class="form-control payment-control btn btn-light btn-info">Business Permit</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="quantity" name="quantity" value="<?= $row['quantity'] ?>" class="form-control payment-control btn btn-light btn-info">
                                </div>
                                <div class="form-group">
