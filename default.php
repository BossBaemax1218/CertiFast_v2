        ...
        <section class="container forms">
            <div class="form">
                <div class="form-content">
                    ...
                    <p class="text-center" style="font-size:13px;">CertiFast Portal is an online platform for efficient and streamlined certificate management, facilitating the issuance, tracking, and verification of certificates for various purposes.</p>
