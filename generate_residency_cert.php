                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_pment.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="details" name="details" placeholder="Enter Payment Details" class="form-control payment-control btn btn-light btn-info">Certificate of Residency</textarea>
                                </div>
                                <div class="form-group">
