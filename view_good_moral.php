...
<?php 
   ...
   $good_moralquery = "SELECT * FROM tblgood_moral AS c JOIN tblresident_requested AS r ON c.requirement = r.requirement WHERE c.good_id='$good_moralid' AND c.cert_name = r.certificate_name AND c.email = r.email AND c.requester = r.resident_name AND r.status IN ('on hold','approved')";
