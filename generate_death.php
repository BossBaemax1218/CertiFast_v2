                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Death Certificate</div>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_pment.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="details" name="details" placeholder="Enter Payment Details" class="form-control payment-control btn btn-light btn-info">Certificate of Death</textarea>
                                </div>
                                <div class="form-group">
