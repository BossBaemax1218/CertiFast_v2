    ...
    <head>
        ...
        <section class="about-section section-padding">
            <div class="container text-center mt-5 mb-5">
                    <h2 class="mb-0">Meet our Barangay Officials</h2><!--<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</span>--></div>

                <div class="container mt-3">
                    <div class="col-md-12">
                        <div class="bg-white p-3 text-center rounded box"><img class="img-responsive rounded-circle" src="images/portrait.jpg" width="150">
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="custom-text-block mb-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 mt-4">
                            <div class="bg-white p-3 text-center rounded box"><img class="img-responsive rounded-circle" src="images/portrait.jpg" width="150">
                                <h5 class="mt-4 name">ROBERTO A. BALLARTA</h5><span class="work d-block">Barangay Captain</span>
                                <div class="mt-4 about"><!--<span>is a long established fact that eader&nbsp; will be distracted by the readable content.</span>--></div>
                                <div class="mt-4">
                                    <a href="" class="v-profile">View Profile</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 mt-4">
