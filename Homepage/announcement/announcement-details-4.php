        ...
        <div class="row gy-4">
            ...
            <div class="announcement-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-5.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-6.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-7.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-8.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="announcement-info">
              <h3>Water Service Interruptio</h3>
              <strong>Date</strong>: 17 March, 2023
            </div>
            <div class="announcement-description">
              <h2>Notice of Water Service Interruption</h2>
              <p>
                EMERGENCY WATER INTERRUPTION  on March 17, 9AM - 9PM.
              </p>
            </div>
          </div>
