    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><b>Announcement Details</b></h2>
        </div>
    ...
    <section id="announcement-details" class="announcement-details">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="announcement-details-slider swiper">
              <div class="swiper-wrapper align-items-center">

                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-4.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-4-1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-4-2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-4-3.jpg" alt="">
                </div>
                
                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-4-4.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-4-5.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="announcement-info">
              <h3>City Transport and Traffic Management Office</h3>
              <strong>Date</strong>: 21 March, 2023
            </div>
            <div class="announcement-description">
              <h2>City Transport and Traffic Management Office</h2>
              <p>
                Pahibalo sa tanang naay Bicycle and Light Mobility Vehicle nga kinahanglan na kini iparehistro. Alang sa detalye sa pagparehistro naa sa pictures nga nakalakip niining post. Daghang salamat.
              </p>
            </div>
          </div>
