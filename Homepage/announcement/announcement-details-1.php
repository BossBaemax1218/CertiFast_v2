        ...
        <div class="row gy-4">
            ...
            <div class="announcement-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-2.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="announcement-info">
              <h3>Social Pension Payout</h3>
              <strong>Date</strong>: 18 April, 2023
            </div>
            <div class="announcement-description">
              <h2>Social Pension Payout</h2>
              <p>
                SOCIAL PENSION FIRST QUARTER 2023 SCHEDULE OF PAYOUT APRIL 18, 2023, 8:00 AM to 1:00 PM at LOS AMIGOS BARANGAY GYM.
              </p>
            </div>
          </div>
