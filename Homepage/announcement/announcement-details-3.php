        ...
        <div class="row gy-4">
            ...
            <div class="announcement-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../assets/img/announcement/announcement-3.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="announcement-info">
              ...
              <strong>Date</strong>: 26 April, 2023
            </div>
            <div class="announcement-description">
              <h2>Sim Registration</h2>
              <p>
                Pahibalo sa tanan na need nato iparehistro atong sim karun abril. Daghang Salamat!
              </p>
            </div>
          </div>
