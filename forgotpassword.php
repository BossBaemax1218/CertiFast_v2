        ...
        <main>
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="mt-2">Forgot your password</h6>
                    </div>
                    <div class="card-body">
                        <form>
                            <span class="mt-1" style="font-size: 14px; text-align: left;">Please enter your email and we'll send you a verification code.</span>
                            <input class="mt-2" type="email" id="email" name="email" placeholder="Email address">
