...
<?php 
   ...
   $family_taxquery = "SELECT * FROM tblfamily_tax AS c JOIN tblresident_requested AS r ON c.requirements = r.requirement WHERE c.fam_id='$family_taxid' AND c.cert_name = r.certificate_name";
