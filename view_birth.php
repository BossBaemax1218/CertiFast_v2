...
<?php 
   ...
   $birthid = $_GET['id'];
   $birthquery = "SELECT * FROM tblbirthcert AS c JOIN tblresident_requested AS r ON c.requirement = r.requirement WHERE c.birth_id='$birthid' AND c.cert_name = r.certificate_name AND c.email = r.email";
