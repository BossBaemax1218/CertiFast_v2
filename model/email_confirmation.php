...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $mail->Subject = 'A new verification code has been sent';

        $stmt = $conn->prepare("SELECT user_email FROM tbl_user_resident WHERE user_email = ? AND account_status = 'unverified'");
        ...
        if ($result->num_rows > 0) {
            ...
            if ($mail->send()) {
                ...
                header('Location: ../email_reverified.php');
                exit();
            } else {
            ...
            $_SESSION['message'] = 'Your failed to confirmed your email address.';
            $_SESSION['success'] = 'danger';
            $_SESSION['form'] = 'signup';
            header('Location: ../email_confirmation.php');
            exit();
