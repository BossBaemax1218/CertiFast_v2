...
if (!empty($fullname) && !empty($purok) && !empty($age)) {
    ...
    $insert_query = "INSERT INTO tbloath(`fullname`,`purok`, `age`, `cert_name`, `requester`,`email`) 
    ...
    if ($result_resident === true) {
        ...
        if ($result_requested === true) {
            $_SESSION['message'] = 'You have requested a certificate of oath taking has been sent!';
