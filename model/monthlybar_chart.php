    <div class="card mr-3">
      <div class="card-header">
        ...
        <div class="card-body">
          <canvas id="monthlyChart" style="width: 100%; max-width: 1450px; height: 350px;"></canvas>
        </div>
    </div>
<?php
...
$monthlyDataQuery = "SELECT DATE_FORMAT(date, '%M') AS month_name, details, COUNT(*) AS monthly_payments FROM tblpayments WHERE YEAR(date) = YEAR(CURDATE()) AND MONTH(date) = MONTH(CURDATE()) GROUP BY MONTH(date), details;";
