...
<?php 
   ...
   $live_inid = $_GET['id'];
   $live_inquery = "SELECT * FROM tbllive_in AS c JOIN tblresident_requested AS r ON c.requirements = r.requirement WHERE c.live_id='$live_inid' AND c.cert_name = r.certificate_name AND c.email = r.email";
